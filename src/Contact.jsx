...
const Contact = () => {
  const Wrapper = styled.section`
    ...
    .container {
      ...
      .bordar-gray {
        border: 0.1rem solid rgb(132 123 108 / 40%);
      }
      ...
      .contact-inputs{
        ...
        input[type="submit"]{
          ...
          border: 1px solid rgb(132 123 108);
          transition: all 0.2s;
    ...
    <Wrapper>
      ...
      <div className="container">
        <div className="contact-form">
          <form action="https://formspree.io/f/mnqyoyvg" method="POST" className="contact-inputs">
            <input
              className="bordar-gray"
              type="text"
              name="username"
